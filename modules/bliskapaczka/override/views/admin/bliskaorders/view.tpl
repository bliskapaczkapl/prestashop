        ...
        <div class="col-lg-7">
            <div class="panel clearfix">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="row">
                        <label class="control-label col-lg-3">Creation date</label>
                        <div class="col-lg-9">
                            <p class="form-control-static">{$order->creation_date}</p>
                        </div>
                    </div>
                    <div class="row">
                        <label class="control-label col-lg-3">Advice date</label>
                        <div class="col-lg-9">
                            <p class="form-control-static">{$order->advice_date|default:"-"}</p>
                        </div>
                    </div>
                    <div class="row">
                        <label class="control-label col-lg-3">Tracking number</label>
                        <div class="col-lg-9">
                            <p class="form-control-static">{$order->tracking_number|default:"-"}</p>
                        </div>
                    </div>
                </div>
            </div>
